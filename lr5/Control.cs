...
namespace lr5
{
    public class Control
    {
        ...
        public Control(View.ViewClub viewClub)
        {
            v_club = viewClub;
        }
        ...
        public Control(View.ViewCoach viewCoach)
        {
            v_coach = viewCoach;
        }
        ...
        public Control(View.ViewGames viewGames)
        {
            v_games = viewGames;
        }
        ...
        View.ViewGum v_gum;
        public Control(View.ViewGum viewGum)
        {
            v_gum = viewGum;
        }
        ...
        public Control(View.ViewSponsor viewSponsor)
        {
        ...
        public Control(View.ViewSportsmen viewSportsmen)
        {
        ...
        public Control(View.ViewTransport viewTransport)
        {
